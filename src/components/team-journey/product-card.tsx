    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4 pb-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 border border-gray-200 p-2 rounded-md">
            ...
            <div>
              <div className="font-semibold text-sm">{product.customers.count} Customers</div>
          ...
          <div className="flex items-center gap-3 border border-gray-200 p-2 rounded-md">
            ...
            <div>
              <div className="font-semibold text-sm">${product.revenue.amount}</div>
              <div className="text-xs text-muted-foreground">{product.revenue.label}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 border border-gray-200 p-2 rounded-md">
            ...
            <div>
              <div className="font-semibold text-sm">{product.points.amount} Points Received</div>
              <div className="text-xs text-muted-foreground">{product.points.label}</div>
            </div>
          </div>
        </div>
      </CardContent>
      ...
      <CardFooter className="pt-0 flex items-center justify-between">
        ...
        <Button 
          ...
          asChild
        >
          <a href={`/dashboard/team-journey/${product.id}`}>
            View Product
          </a>
        </Button>
      </CardFooter>
