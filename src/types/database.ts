  ...
  public: {
    Tables: {
      ...
      scholarship_agreement_events: {
        Row: {
          agreement_id: string;
          event_type: Database["public"]["Enums"]["scholarship_event_type"];
          id: string;
          occurred_at: string;
          payload: Json | null;
        };
        ...
        Relationships: [
          {
            foreignKeyName: "scholarship_agreement_events_agreement_id_fkey";
            columns: ["agreement_id"];
            isOneToOne: false;
            referencedRelation: "scholarship_agreements";
            referencedColumns: ["id"];
          },
        ];
      };
    ...
    Functions: {
      ...
      ai_review_apply_decision_v1_backup_v2: {
        Args: { p_outcome: string; p_payload?: Json; p_review_id: string };
        Returns: Json;
      };
      ai_review_claim_v1: {
      ...
      check_and_award_achievement_v2: {
        Args: { p_achievement_id: string; p_user_id: string };
        Returns: Json;
      };
      ...
      get_analytics_tasks_v2: { Args: { p_batch_id: string }; Returns: Json };
      ...
      get_analytics_week_detail_v2: {
        Args: { p_batch_id: string; p_week_start: string };
        Returns: {
          alignment_reason: string;
          blockers: string;
          report_id: string;
      ...
      get_individual_weekly_report_status_v1: { Args: never; Returns: Json };
      ...
      get_user_achievement_progress_backup_v1: {
        Args: { p_user_id: string };
        Returns: {
          achievement_description: string;
          achievement_icon: string;
      ...
      get_user_profile_card_v2: { Args: { p_user_id: string }; Returns: Json };
      ...
      scholarship_record_event: {
        Args: {
          p_event_type: Database["public"]["Enums"]["scholarship_event_type"];
          p_id: string;
          p_payload: Json;
        };
        Returns: undefined;
      ...
      scholarship_record_school_signer: {
        Args: { p_id: string; p_school_signer_token: string };
        Returns: {
          agreement_type: Database["public"]["Enums"]["scholarship_agreement_type"];
          archived_at: string | null;
          callback_ref: string | null;
      ...
      submit_individual_weekly_report_v1: {
        Args: { p_as_draft?: boolean; p_submission_data: Json };
        Returns: Json;
      };
      submit_peer_review: {
        Args: {
