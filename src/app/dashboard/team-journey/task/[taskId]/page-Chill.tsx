              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  {task.detailed_instructions ? (
                    <div className="text-gray-700 space-y-4 [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:mb-4 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mb-3 [&_h2]:mt-6 [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:space-y-2 [&_li]:leading-relaxed [&_p]:leading-relaxed">
                      <ReactMarkdown>
                        {task.detailed_instructions}
                      </ReactMarkdown>
                    </div>
                  ...
                  task.peer_review_criteria.length > 0 ? (
                    task.peer_review_criteria.map((criteria, index) => (
                      <div key={index}>
                        ...
                        <div className="text-gray-700 space-y-4 [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:mb-4 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mb-3 [&_h2]:mt-6 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:mb-2 [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:space-y-2 [&_li]:leading-relaxed [&_p]:leading-relaxed [&_strong]:font-bold">
